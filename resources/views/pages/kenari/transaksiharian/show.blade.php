            ...
            <form action="" method="">
              ...
              <div class="container so-container">  
                <div class="form-group row justify-content-center" >
                  ...
                  <div class="col-1 mt-1" style="margin-left: -10px">
                    <button type="submit" tabindex="3" formaction="{{ route('trans-show-kenari') }}" formmethod="GET" id="btn-cari" class="btn btn-primary btn-sm btn-block text-bold">Cari</button>
                  </div>
                </div>  
              </div>
              <hr>
              ...
              <table class="table table-sm table-bordered table-striped table-responsive-sm table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  @empty
                    <tr>
                      <td colspan="8" class="text-center text-bold text-dark h4 py-2">Tidak Ada Data Transaksi pada Tanggal Ini</td>
                    </tr>
                  @endforelse
                </tbody>
              </table>
