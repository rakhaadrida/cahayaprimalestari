            ...
            <form action="" method="">
              ...
              <div class="container so-container">
                <div class="row">
                  ...
                  <div class="col" style="margin-left: -380px">
                    <div class="form-group row sj-first-line">
                      <label for="tglSO" class="col-5 col-form-label text-bold text-right">Tanggal SO</label>
                      <span class="col-form-label text-bold">:</span>
                      <div class="col-3">
                ...
                <div class="form-group row sj-left-input">
                  <label for="nama" class="col-2 col-form-label text-bold">Tanggal SJ</label>
                  <span class="col-form-label text-bold">:</span>
                  <div class="col-2 mt-1">
                ...
                <div class="form-group row input-header">
                  <label for="alamat" class="col-2 col-form-label text-bold">Keterangan</label>
                  <span class="col-form-label text-bold">:</span>
                  <div class="col-5">
              ...
              <table class="table table-sm table-bordered table-striped table-responsive-sm table-hover" id="tablePO">
                <thead class="text-center text-bold text-dark">
                  ...
                  <td style="width: 90px">Qty Revisi</td>
                  <td>Keterangan</td>
