            ...
            <form action="" method="">
              ...
              <div class="container so-container">  
                <div class="form-group row justify-content-center" >
                  ...
                  <div class="col-2">
                    <input type="text" tabindex="1" class="form-control datepicker form-control-sm text-bold mt-1" name="tglAwal" id="tglAwal" value="{{ $tglAwal }}" autocomplete="off" autofocus>
                  </div>
                  <label for="tanggal" class="col-auto col-form-label text-bold ">s/d</label>
                  <div class="col-2">
                    <input type="text" tabindex="2" class="form-control datepicker form-control-sm text-bold mt-1" name="tglAkhir" id="tglAkhir" value="{{ $tglAkhir }}" autocomplete="off">
                  </div>
                  ...
                  <div class="col-auto mt-1" style="margin-left: -10px">
                    <button type="submit" tabindex="6" formaction="{{ route('trans-home') }}" formmethod="POST" class="btn btn-outline-secondary btn-sm btn-block text-bold">Reset Filter</button>
                  </div>
                  ...
                  <div class="col-auto mt-1" style="margin-left: -10px">
                    <button type="submit" tabindex="5" formaction="{{ route('ar-cetak', 'Prime') }}" formmethod="POST" formtarget="_blank" id="btn-cari" class="btn btn-success btn-sm btn-block text-bold ">Print Prime</button>
                  </div>
                </div>  
              </div>
              <hr>
