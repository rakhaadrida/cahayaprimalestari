...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-0">
      <h1 class="h3 mb-0 text-gray-800 menu-title">Data Retur Customer</h1>
      <div class="justify-content-end">
        <a href="{{ route('ret-index-jual') }}" tabindex="1" class="btn btn-sm btn-primary shadow-sm">
          <i class="fas fa-plus fa-sm text-white-50 mr-1"></i>  Input Retur Customer
        </a>
    </div>
  </div>
  @if ($errors->any())
                ...
                <tbody class="table-ar">
                  ...
                  @forelse($retur as $r)
                    ...
                    <tr class="text-dark">
                      ...
                      <td class="align-middle text-right">{{ $qtyProses[0]->totalKirim != 0 ? $qtyProses[0]->totalKirim : '' }}</td>
                      <td class="align-middle text-right">{{ $qtyPotong[0]->totalPotong != 0 ? $qtyPotong[0]->totalPotong : '' }}</td>
