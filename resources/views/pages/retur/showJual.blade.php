              ...
              <div class="container so-container"> 
                ...
                <div class="form-group row" style="margin-top: -10px">
                  ...
                  <div class="col-auto mt-1" style="margin-left: -10px">
                    <button type="submit" tabindex="6" formaction="{{ route('home-jual', ['status' => 'false', 'id' => '0']) }}" formmethod="POST" class="btn btn-danger btn-sm btn-block text-bold">Reset Filter</button>
                  </div>
                </div>  
              </div>
              <hr>
