          ...
          <div class="card-body">
            <form action="" method="">
                ...
                <div class="row">
                  ...
                  <div class="col" style="margin-left: -580px">
                    ...
                    <div class="form-group row sj-after-first">
                      ...
                      <span class="col-form-label text-bold">:</span>
                      <div class="col-3">
                        <input type="text" readonly class="form-control-plaintext form-control-sm text-bold text-dark mt-1" name="namaSales"
              ...
              <div class="form-row justify-content-center">
                <div class="col-2">
                  <button type="submit" formaction="{{ route('ret-process-jual', $items[0]->id_so) }}" formmethod="POST" class="btn btn-success btn-block text-bold">Submit</>
                </div>
                <div class="col-2">
                  <button type="reset" class="btn btn-outline-danger btn-block text-bold">Reset</button>
                </div>
                <div class="col-2">
                  <a href="{{ route('retur-jual') }}" class="btn btn-outline-primary btn-block text-bold">Kembali</a>
                </div>
              </div>
