<html lang="en">
    ...
    <body>
        ...
        @foreach($items as $item)
            <div class="cetak-all-container" style="margin-bottom: -55px; page-break-after: auto;">
                ...
                <table class="table table-sm table-responsive-sm table-hover table-info-cetak-so">
                    <thead class="text-center text-bold" style="font-weight: 600">
                ...
                @php
                    $itemsDet = \App\Models\DetilRJ::select('id_barang')
                        ->selectRaw('sum(qty_kirim) as qty_kirim')
                ...
                <table class="table table-sm table-responsive-sm table-cetak" style="page-break-inside: auto">
                    ...
                    @foreach($itemsDet as $it)
                        <tr class="baris-so">
                            ...
                            @if($it->barang->satuan == "Pcs / Dus")
                                <td align="center">{{ $it->qty_kirim }} PCS</td>
                            @elseif($it->barang->satuan == "Set")
                                <td align="center">{{ $it->qty_kirim }} SET</td>
                            @elseif($it->barang->satuan == "Meter / Rol")
                                <td align="center">{{ $it->qty_kirim }} ROL</td>
                            @else
                                <td align="center">{{ $it->qty_kirim }} MTR</td>
                            @endif
                            <td align="right">0</td>
                            <td align="right">0</td>
                            <td style="width: 55px" align="right">0</td>
                                ...
                                <div class="total-faktur">
                                    <table class="tabel-total-faktur">
                                        <tr>
                                            ...
                                            <td class="text-right angka-total">{{ $itemsDet->count() <= 12 ? '0' : '' }}</td>
                                        </tr>
                                        <tr>
                                            <td class="title-total text-bold">Disc Faktur</td>
                                            <td class="text-right angka-total">{{ $itemsDet->count() <= 12 ? '0' : 'Bersambung' }}</td>
                                        </tr>
                                        <tr>
                                            <td class="title-total text-bold">Nilai Netto</td>
                                            <td class="text-right angka-total" @if($itemsDet->count() > 12) style="letter-spacing: 0.7px;" @endif>{{ $itemsDet->count() <= 12 ? 0 : 'ke halaman' }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right angka-total-akhir">{{ $itemsDet->count() <= 12 ? '0' : '' }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </td>
