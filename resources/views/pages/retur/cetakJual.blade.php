      ...
      <table class="table table-sm table-responsive-sm table-hover table-info-cetak-so">
        ...
        <tbody class="text-bold">
          <tr class="tr-info-cetak-so">
            <td align="center">{{ $items[0]->id_retur }}</td>
            <td align="center">
              {{ \Carbon\Carbon::parse($items[0]->tgl_kirim)->format('d-M-y') }}
            </td>
            <td align="center">0 Hari</td>
            <td align="center"></td>
            <td align="center">{{ $items[0]->retur->customer->sales->nama }}</td>
            ...
            <tr>
              ...
              <td style="border-right: 2px dotted; width: 85px">
                <div class="ttd-mengetahui">
                  ...
                  <table style="font-size: 12px !important">
                    <tr>
                      <td class="tgl-ttd">{{ \Carbon\Carbon::parse($items[0]->tgl_kirim)->format('d-M-y')}}</td>
                    </tr>
                    <tr>
