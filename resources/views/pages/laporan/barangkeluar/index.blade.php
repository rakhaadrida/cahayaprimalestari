            ...
            <form action="" method="">
              ...
              <div class="container so-container">  
                <div class="form-group row justify-content-center" style="margin-top: -10px">
                  ...
                  <div class="col-2">
                    <input type="text" class="form-control datepicker form-control-sm text-bold mt-1" name="tglAwal" id="tglAwal" placeholder="DD-MM-YYYY" value="{{ $tglAwal != NULL ? $tglAwal : ''}}" autocomplete="off" required autofocus>
                  </div>
