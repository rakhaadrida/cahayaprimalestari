                                ...
                                <div id="so-carousel" class="carousel slide" data-interval="false" wrap="false">
                                    <div class="carousel-inner">
                                        ...
                                        @foreach($itemsBRG as $item)
                                            <div class="carousel-item @if($item->id == $itemsBRG[0]->id) active @endif ">
                                                <div class="container so-update-container">
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="col-form-label text-bold">:</span>
                                                        <div class="col-6">
                                                            <input type="text" readonly class="form-control-plaintext col-form-label-sm text-bold text-dark" value="{{ $item->id }} - {{ $item->nama }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    @if($items->count() != 0)
                                                        ...
                                                        @foreach($items as $it)
                                                            <tr class="text-dark">
                                                                ...
                                                                @foreach($gudang as $g)
                                                                    @php
                                                                        if(($g->id == 'GDG01') && (substr($it->id, 0, 3) == 'KRM')) {
