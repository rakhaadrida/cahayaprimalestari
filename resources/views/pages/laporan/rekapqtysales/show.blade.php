            ...
            <form action="" method="">
              ...
              <div class="container so-container">  
                <div class="form-group row justify-content-center" style="margin-top: -10px">
                  ...
                  <span class="col-form-label text-bold">:</span>
                  <div class="col-2">
                    <input type="text" tabindex="1" class="form-control form-control-sm text-bold mt-1" name="sales" id="sales" value="{{ $sal }}" autocomplete="off" autofocus>
                    <input type="hidden" name="kode" id="kode" value="{{ $id }}">
                  </div>
                  <label for="tanggal" class="col-auto col-form-label text-bold">Kategori</label>
                  <span class="col-form-label text-bold">:</span>
                  <div class="col-2">
                    <input type="text" tabindex="1" class="form-control form-control-sm text-bold mt-1" name="kategori" id="kategori" value="{{ $jen }}" autocomplete="off" autofocus>
                    <input type="hidden" name="jenis" id="jenis" value="{{ $idJen }}">
                  </div>
                  ...
                  <div class="col-auto mt-1" style="margin-left: -10px">
                    <button type="submit" tabindex="6" formaction="{{ route('qty-sales') }}" formmethod="GET" class="btn btn-outline-danger btn-sm btn-block text-bold">Reset Filter</button>
                  </div>
                </div>  
              </div> 
              <hr> 
                  ...
                  {{-- <div class="carousel-item @if($item->id == $jenis[0]->id) active @endif"/> --}}
                    <div class="container" style="margin-bottom: 0px">
                      <div class="row justify-content-center">
                        <h4 class="text-bold text-dark">Rekap Qty Penjualan Bulan {{ $bul != '' ? $bul : $bulanNow }} {{ $year }}</h4>
                      </div>
