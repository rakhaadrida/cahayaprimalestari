...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-2">
      <h1 class="h3 mb-0 text-gray-800 menu-title">Tambah Data Harga</h1>
  </div>
  @if ($errors->any())
          ...
          <div class="card-body">
            <form action="{{ route('harga.store') }}" method="POST">
              ...
              <div class="form-group row">
                ...
                <span class="col-form-label text-bold">:</span>
                <div class="col-4">
                  <input type="text" class="form-control col-form-label-sm" name="nama" placeholder="Nama Harga" value="{{ old('nama') }}" autocomplete="off" required autofocus>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-1">
                  ...
                  value="{{ old('tipe') }}" autocomplete="off" required>
                </div>
              </div>
              <hr>
