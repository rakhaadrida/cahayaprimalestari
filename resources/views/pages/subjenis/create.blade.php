...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-2">
      <h1 class="h3 mb-0 text-gray-800 menu-title">Tambah Data Sub Jenis Barang</h1>
  </div>
  @if ($errors->any())
          ...
          <div class="card-body">
            <form action="{{ route('subjenis.store') }}" method="POST">
              ...
              <div class="form-group row">
                ...
                <span class="col-form-label text-bold">:</span>
                <div class="col-4">
                  <input type="text" class="form-control col-form-label-sm" name="nama" placeholder="Nama Sub Jenis Barang" value="{{ old('nama') }}" required>
                </div>
              </div>
              <div class="form-group row">
