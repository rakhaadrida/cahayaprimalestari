          ...
          <form action="" method="POST">
              ...
              <tbody id="tablePO{{$a->id}}" class="table-ar">
                @php 
                  ...
                  $retur = App\Models\DetilRAP::join('ap_retur', 'ap_retur.id', 
                          'detilrap.id_retur')->where('id_ap', $a->id)->orderBy('tgl_retur', 'asc')->get();
                @endphp
                @foreach($retur as $d)
            ...
            @if($a->keterangan == 'BELUM LUNAS')
              <div class="form-row justify-content-center">
                <div class="col-3">
                  <button type="submit" id="submitRT{{$a->id}}" class="btn btn-success btn-block text-bold" formaction="{{ route('ap-retur') }}" formmethod="POST">Submit</button>
                </div>
                <div class="col-3">
