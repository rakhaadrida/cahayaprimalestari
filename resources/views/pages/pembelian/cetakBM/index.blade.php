                ...
                <tbody>
                  ...
                  @forelse ($items as $item)
                    <tr class="text-dark">
                      ...
                      <td class="text-center"><button type="submit" tabindex="{{ $tab++ }}" formaction="{{ route('cetak-bm-detail', $item->id) }}" formmethod="POST" class="btn btn-sm btn-link text-bold">{{ $item->id }}</button></td>
