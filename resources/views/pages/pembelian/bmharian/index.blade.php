              ...
              <div class="container so-container">  
                <div class="form-group row justify-content-center" >
                  ...
                  <div class="col-1 mt-1" style="margin-left: -10px">
                    <button type="submit" id="btn-cari" formaction="{{ route('bm-harian-show') }}" 
                    formmethod="GET" class="btn btn-primary btn-sm btn-block text-bold">Cari</button>
                  </div>
                  <div class="col-2 mt-1">
                    <button type="submit" tabindex="5" formaction="{{ route('bm-harian-excel-now') }}" formmethod="POST" id="btn-cari" class="btn btn-success btn-sm btn-block text-bold ">Excel</button>
                  </div>
                </div>  
              </div>
              <hr>
