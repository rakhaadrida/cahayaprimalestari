              ...
              <div class="container so-container">  
                <div class="form-group row justify-content-center" >
                  ...
                  <div class="col-1 mt-1" style="margin-left: -10px">
                    <button type="submit" formaction="{{ route('bm-harian-show') }}" formmethod="GET" id="btn-cari" class="btn btn-primary btn-sm btn-block text-bold">Cari</button>
                  </div>
                </div>  
              </div>
              <hr>
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group row">
                            ...
                            <span class="col-form-label text-bold">:</span>
                            <div class="col-2">
                              <input type="text" readonly class="form-control-plaintext col-form-label-sm text-bold text-dark" value="{{ $item->id_faktur }}" >
                            </div>
                          </div>
                        </div> 
                        <div class="col" style="margin-left: -500px">
                          <div class="form-group row">
                            ...
                            <span class="col-form-label text-bold">:</span>
                            <div class="col-7">
                              <input type="text" readonly class="form-control-plaintext col-form-label-sm text-bold text-dark" value="{{ $item->supplier->nama }}" >
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col" style="margin-left: -500px">
                          <div class="form-group row customer-detail">
                            ...
                            <span class="col-form-label text-bold">:</span>
                            <div class="col-4">
                              <input type="text" readonly class="form-control-plaintext col-form-label-sm text-bold text-dark" value="{{ $item->gudang->nama }}">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col" style="margin-left: -500px">
                          <div class="form-group row customer-detail">
                            ...
                            <span class="col-form-label text-bold">:</span>
                            <div class="col-4">
                              <input type="text" readonly class="form-control-plaintext col-form-label-sm text-bold text-dark" value="{{ \Carbon\Carbon::parse($item->tanggal)->add($item->tempo, 'days')->format('d-M-y') }}" >
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <tbody>
                        @php 
                          ...
                          $itemsDetail = \App\Models\DetilBM::with(['barang'])
                                      ->select('id_barang', 'harga')->selectRaw('sum(qty) as qty')
                                      ->where('id_bm', $item->id)->groupBy('id_barang')
                                      ->get();
                        @endphp
