            ...
            <form action="" method="">
              ...
              <table class="table table-sm table-bordered table-striped table-responsive-sm table-hover" id="dataTable" width="100%" cellspacing="0">
                <thead class="text-center text-bold text-dark">
                  ...
                  <th style="width: 80px" class="align-middle">Tanggal</th>
                  <th class="align-middle">Supplier</th>
                  <th style="width: 80px" class="align-middle">Total</th>
                  <th style="width: 80px" class="align-middle">Gudang</th>
                ...
                <tbody>
                  ...
                  @forelse ($items as $item)
                    <tr class="text-dark">
                      ...
                      <td class="text-center"><button type="submit" tabindex="{{ $tab++ }}" formaction="{{ route('bm-harian-detail', $item->id) }}" formmethod="POST" class="btn btn-link btn-sm text-bold">{{ $item->id_faktur }}</button></td>
