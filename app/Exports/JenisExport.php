...
class JenisExport implements FromView, ShouldAutoSize, WithStyles
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        $items = JenisBarang::withTrashed()->get();
        ...
        return view('pages.jenisbarang.excel', $data);
    }

    public function styles(Worksheet $sheet)
    {   
        $sheet->setTitle('JenisBarang');
